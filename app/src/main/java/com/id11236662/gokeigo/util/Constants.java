...
/**
 * This class contains all public static constants used in this project.
 */
public class Constants {
    public static final String TAG = "MAD";
    public static final String INTENT_SELECTED_ENTRY = "INTENT_SELECTED_ENTRY";
    public static final String INTENT_ENTRY_WORD_AND_READING = "INTENT_ENTRY_WORD_AND_READING";
